...
const PASSWORD = process.env.NEXT_PUBLIC_BONDINHO_PASSWORD ?? "";
    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          >
            <Lock className="w-5 h-5" style={{ color: "#F59E0B" }} strokeWidth={1.5} />
          </div>
          ...
          <p className="text-gray-500 text-sm leading-relaxed">
            ...
            <span className="text-gray-400">Bondinho Pão de Açúcar × River Labs</span>
          </p>
        </div>
