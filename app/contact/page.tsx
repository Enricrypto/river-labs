    ...
    return (
      <div className="min-h-screen bg-[#f6faf8] flex items-center justify-center px-6">
        <div className="w-full max-w-md text-center">
          ...
          <h2 className="font-serif text-3xl text-gray-900 font-medium mb-3">Mensagem enviada.</h2>
          <p className="text-gray-500 text-base leading-relaxed mb-8">
            Recebemos o seu contato e retornaremos em até <span className="text-gray-900 font-medium">48 horas</span>.
          </p>
          <Link
            href="/"
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <h1 className="font-serif text-4xl md:text-5xl font-medium tracking-tight text-gray-900 mt-3 mb-6 leading-tight">
              Vamos conversar<br className="hidden md:block" /> sobre o seu negócio
            </h1>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Field label="Nome completo *" value={form.name} onChange={v => set("name", v)} placeholder="João Silva" />
                <Field label="E-mail *" type="email" value={form.email} onChange={v => set("email", v)} placeholder="joao@empresa.com" />
              </div>
              <Field label="Empresa" value={form.company} onChange={v => set("company", v)} placeholder="Nome da sua empresa" />
              <Field label="Mensagem *" value={form.message} onChange={v => set("message", v)} placeholder="Conte brevemente o que você está buscando…" multiline />
              ...
              <p className="text-gray-400 text-xs text-center">
                Sem spam. Só retornamos para falar sobre o seu projeto.
              </p>
            </form>
          </div>
        </div>
...
function Field({
  ...
  const base =
    "w-full bg-gray-50 border border-gray-200 rounded-xl px-4 text-gray-900 text-sm placeholder-gray-400 outline-none transition-all focus:border-pastel-blue focus:bg-white";
  return (
