...
const en: Dict = {
  ...
  team: {
    ...
    members: [
      ...
      { name: "Enrique Ibarra", role: "Full Stack Engineer", bio: "Bio coming soon.", fullBio: "Enrique Ibarra works at the intersection of artificial intelligence, blockchain, and digital development, with a focus on turning technology into practical solutions for businesses. He builds and implements systems that improve processes, reduce costs, and increase efficiency through automation and the intelligent use of data.\n\nHis projects have international reach, including initiatives in Europe, Latin America, and the Middle East, and focus on applying AI strategically — helping organizations adopt new technologies without unnecessary complexity. His approach combines structured thinking with a practical mindset, always looking for the right questions and solutions that actually work day-to-day across different industries.\n\nThroughout his career, he has also developed expertise in Web3 and application development, working with digital products and new forms of technological infrastructure. His focus is on building useful, well-designed solutions aligned with real business needs.", image: "/Enrique_PP.png" },
    ],
  },
  methodology: {
    heading: "How we work",
