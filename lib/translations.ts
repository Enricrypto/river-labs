...
const en: Dict = {
  ...
  whyus: {
    ...
    features: [
      ...
      { title: "Spanish + English", desc: "Native dual-language support for dashboards and documentation, perfect for international teams." },
    ],
    cta: "Get a Quote",
  },
  faq: {
...
const es: Dict = {
  ...
  whyus: {
    ...
    features: [
      ...
      { title: "Español + Inglés", desc: "Soporte nativo bilingüe para dashboards y documentación, ideal para equipos internacionales." },
    ],
...
const pt: Dict = {
  ...
  whyus: {
    ...
    features: [
      ...
      { title: "Português + Inglês", desc: "Suporte nativo bilíngue para dashboards e documentação, ideal para equipes internacionais." },
    ],
