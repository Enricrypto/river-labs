    ...
    <footer className="w-full border-t border-gray-200 bg-white pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
        ...
        <Link
          ...
          className="hidden md:inline-flex items-center justify-center px-4 py-2 rounded-lg bg-gray-50 text-gray-700 text-base font-medium hover:bg-gray-100 transition-colors border border-gray-200"
        >
