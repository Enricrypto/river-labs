    ...
    <section className="pt-6 pb-12 px-4 md:px-6 w-full max-w-7xl mx-auto flex flex-col items-center">
      <div className="w-full bg-[#0F1D56] rounded-[2rem] md:rounded-[3rem] px-8 md:px-16 py-20 md:py-32 flex flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl">
          <h1
            className={`font-serif text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-medium text-white tracking-tight leading-[1.08] ${mounted ? "hero-fade-1" : "opacity-0"}`}
          >
            {dict.heading1}{" "}
          ...
          <p
            className={`text-lg md:text-xl text-white/55 mt-8 mb-10 leading-relaxed font-normal max-w-2xl ${mounted ? "hero-fade-2" : "opacity-0"}`}
          >
            {dict.sub}
          </p>
