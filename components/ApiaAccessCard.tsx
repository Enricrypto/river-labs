  ...
  return (
    <section className="py-16 bg-gray-950">
      <div className="max-w-7xl mx-auto px-6">
        <Link
          href="/apia"
          className="group block rounded-3xl p-8 md:p-12 transition-all duration-300 hover:border-[#A3BFFA]/30"
          style={{
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-start gap-5">
              ...
              >
                <Lock className="w-4.5 h-4.5 text-[#A3BFFA]" strokeWidth={1.5} />
              </div>
              <div>
                <p className="text-[#A3BFFA] text-xs font-medium tracking-widest uppercase mb-1.5">
                  Acesso restrito
                </p>
            ...
            <div
              className="shrink-0 flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium text-[#A3BFFA] transition-colors group-hover:bg-[#A3BFFA]/10"
